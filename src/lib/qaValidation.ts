...
export const evaluateExercise = (exercise: QaExercise, response: string | number): EvaluationResult => {
...
export const getTokenChecklist = (exercise: QaExercise, response: string) => {
