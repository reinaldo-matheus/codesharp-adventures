import { qaPhases, getExercisesByPhase } from "@/data/qaLessons";
import { MapPin, Lock, CheckCircle2, Sparkles } from "lucide-react";

interface QaWorldMapProps {
...
const nodePositions = [
  { x: 12, y: 78 }, // Phase 1 - Vila do Aprendiz
  { x: 30, y: 58 }, // Phase 2 - Academia
  { x: 22, y: 32 }, // Phase 3 - Forja
  { x: 45, y: 18 }, // Phase 4 - Oficina Java
  { x: 68, y: 30 }, // Phase 5 - Cavernas da API
  { x: 85, y: 55 }, // Phase 6 - Santuário REST Assured
  { x: 65, y: 80 }, // Phase 7 - Torre CI/CD
];

export const QaWorldMap = ({ currentPhaseId, completedExercises, totalExercises, onClose }: QaWorldMapProps) => {
        ...
        <div className="card-quest p-6 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-cinzel text-2xl font-bold text-gold">Mapa da Qualidade</h2>
          ...
          >
            ...
            <div className="absolute inset-0 opacity-10">
              <svg className="w-full h-full">
                <defs>
                  <pattern id="qa-grid" width="50" height="50" patternUnits="userSpaceOnUse">
                    <path d="M 50 0 L 0 0 0 50" fill="none" stroke="currentColor" strokeWidth="0.5" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#qa-grid)" className="text-gold" />
              </svg>
            </div>
