...
import { QaExercise } from "@/data/qaLessons";
import { evaluateExercise, getTokenChecklist } from "@/lib/qaValidation";
import { Check, X, Scroll, ChevronRight, Lightbulb, Keyboard, Code2, CheckCircle2, Circle } from "lucide-react";

interface QaQuestCardProps {
  exercise: QaExercise;
...
const kindLabel: Record<QaExercise["kind"], { label: string; icon: JSX.Element }> = {
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className={`font-display font-semibold mb-1 ${isCorrect ? "text-success" : "text-destructive"}`}>
                {isCorrect ? "Boa, Guardião(ã)! Resposta certa." : "Quase lá!"}
              </p>
